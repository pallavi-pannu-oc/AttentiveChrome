...
def load_data(args):
	...
	cell_train_dict1=loadData(args.data_root+"train.csv",args.n_bins)
	train_inputs = HMData(cell_train_dict1)

	print("==>loading valid data")
	cell_valid_dict1=loadData(args.data_root+"valid.csv",args.n_bins)
	valid_inputs = HMData(cell_valid_dict1)

	print("==>loading test data")
	cell_test_dict1=loadData(args.data_root+"test.csv",args.n_bins)
